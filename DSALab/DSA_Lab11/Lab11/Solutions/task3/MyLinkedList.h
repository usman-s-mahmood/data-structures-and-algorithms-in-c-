...
class MyLinkedList: public LinkedList<T>
{
    public:
        ...
        void deleteAtTailRecursive();
        void printLinkedList();
        ~MyLinkedList(){}
    private:
        void insertAtTailRecursiveHelper(struct Node<T>* node, T value);
        void deleteAtTailRecursiveHelper(Node<T>* node);
        void printLinkedListHelper(Node<T>* node);
};
...
template <class T>
void MyLinkedList<T>::deleteAtTailRecursiveHelper(Node<T>* node) 
{
    if (node->next == this->tail) 
    {
        ...
        deleteAtTailRecursiveHelper(node->next);
}

template <class T>
void MyLinkedList<T>::deleteAtTailRecursive() 
{
    ...
    else if (this->head == this->tail) 
    {
        ...
        deleteAtTailRecursiveHelper(this->head);
}
...
void MyLinkedList<T>::printLinkedList() 
{
    ...
    {
        printLinkedListHelper(this->head);
        cout << endl;
    }
}

template <class T>
void MyLinkedList<T>::printLinkedListHelper(Node<T>* node) 
{
    if (node == nullptr) 
        return;
    cout << node->data << ' ';
    printLinkedListHelper(node->next);
}